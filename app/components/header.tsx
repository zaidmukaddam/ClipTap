    ...
    <>
      <div className="flex flex-col items-center justify-center px-4 pt-12">
        <div className="flex items-center space-x-6">
          ...
          <a href="https://github.com/zaidmukaddam/Cliptap" title="GitHub">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              ...
              >
                <div className="relative w-screen max-w-md">
                  ...
                  <div className="h-full flex flex-col py-6 bg-gray-900 shadow-xl overflow-y-auto">
                    ...
                    <div className="mt-6 relative flex-1 px-4 sm:px-6 text-gray-300">
                      <p>
                        Cliptap allows you to share your clipboard with other
                        devices.
                      </p>

                      <p className="mt-4">
                        All you need to do is open Cliptap on your device and
